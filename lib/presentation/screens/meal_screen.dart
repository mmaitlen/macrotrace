...
class MealScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl.sl<MealFormBloc>()..add(LoadMealForm(mealId)),
                ...
                builder: (context) {
                  ...
                  if (state.status == MealFormStatus.success ||
                    ...
                    final sortedFoodItems = [...state.foodItems]
                      ..sort((a, b) {
                        final aIsSelected = state.selectedFoodEntries
                            .containsKey(a.id);
                        final bIsSelected = state.selectedFoodEntries
                            .containsKey(b.id);
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isSelected = state.selectedFoodEntries
                            .containsKey(foodItem.id);

                        if (isSelected) {
                          final points =
                              state.selectedFoodEntries[foodItem.id]!;
                          return ListTile(
